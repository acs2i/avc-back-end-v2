...
router.get(BLOCK, async (req: Request, res: Response) => {
    try {
      ...
      const response = await Get("/block", undefined, intPage, intLimit);
...
router.get(BLOCK + "/search", async(req: Request, res: Response) => {
  try {
    ...
    const response = await Get("/block/search", undefined, intPage, intLimit, {code, label, status});
...
router.get(BLOCK + "/:id", async (req: Request, res: Response) => {
  ...
  try {
    ...
    const response = await Get("/block", id);
